...
const DEFAULT_ITEMS = [
    {
        ...
        description: ["html", "sass", "bootstrap", "css"],
        id: 1,
        icon: <FiFileText className="h-[16px] w-[16px] text-white" />,
        img: image.Restaurant,
    },
    {
        title: "Restaurant website",
        description: ["html", "sass", "bootstrap", "css"],
...
export default function CarouselPr4({
    items = DEFAULT_ITEMS,
    baseWidth = 300,
    autoplay = false,
    autoplayDelay = 3000,
                ...
                {carouselItems.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <img src={item.img} loading="lazy" alt="" className="w-[100%] h-[100%]" />
